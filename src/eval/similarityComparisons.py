...
if __name__ == "__main__":
    ...
    path_real = "/home/marlen/Desktop/presentation_meeting/eval/ssim/cyclegan/test/real"
    path_fake = "/home/marlen/Desktop/presentation_meeting/eval/ssim/cyclegan/test/fake"

    for real_file in os.listdir(path_real):
        ending = real_file[-6:]
        real_im = cv2.imread(os.path.join(path_real,real_file))
        fake_file = real_file[:-10] + "fake" + ending
        fake_im = cv2.imread(os.path.join(path_fake,fake_file))
        print(real_file)
        compare_images(real_im, fake_im, "Original vs. synthesized")
